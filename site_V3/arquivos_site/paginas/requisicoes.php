...
$sql = "SELECT id_produto, produto, caracteristica, peso_unidade, estoque, descricao, categoria FROM produtos where usuario = ?";
...
<div class="requisicao">
    ...
    <div class="area1" id="area">
      ...
      <strong>Marca: <span id="marca"></span> </strong>  
       <p><strong>Última atualização:</strong> <span id="ultimaAtualizacao">Sem Atualizações</span></p>
        </div>
...
<p><span class="identificar2">Novos Produtos</span></p>
        ...
        <input type="text" name="Ncaracteristica" id="Ncaracteristica">
        ...
        <input type="text" name="novo_peso" id="novo_peso">
