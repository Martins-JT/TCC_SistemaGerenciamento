/* function editarInformacoes() {
  ...
  document.querySelector('.container1').style.maxHeight = '190px';
  ...
  let medida = document.getElementById('medida_inserida').value;
  ...
  document.querySelector('.container1').style.maxHeight = '150px';
  document.querySelectorAll('.informs-info').forEach(el => {
