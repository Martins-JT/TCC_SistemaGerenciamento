...
CREATE TABLE IF NOT EXISTS PERMISSOES (
    ...
    NOME CHAR(13) NOT NULL UNIQUE
);
INSERT INTO PERMISSOES (NOME) VALUES ('usuario'), ('suporte'), ('suporte geral'), ('admin');
...
create table if not exists notificacoes(id int primary key auto_increment,
                                       fornecedor int not null,
                                       oferta int,
                                       ANR_aprovado varchar(1) default "n",
                                       SN_visto varchar(1) default "n" not null,
                                       destinatario int,
