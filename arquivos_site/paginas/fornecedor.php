...
?>
  ...
  <div class="ofertas testar" data-nome_empresa="<?php echo $linha['nome_empresa']; ?>"><!-- ABERTURA DIV OFERTAS -->
...
<div class="area1" id="area2"> <!-- Abertura da div area2(segunda área da home) -->
  <p><span class="identificar2">Requisições</span></p>
  ...
  function pesquisa()
{
  ...
  {
    //console.log(nomeEmpresa[i]); 
    let elemento = nomeEmpresa[i].getAttribute('data-nome_empresa').toLowerCase();
    //let elemento = nomeEmpresa[i].textContent.toLowerCase();
...
/* function Teste() {
 ...
 document.querySelectorAll('.contador').forEach(span => {
  ...
  if (dataInicio && diasSelecionados) {
   ...
   <?php 
    include_once('../../arquivos_php/fechar_conexao.php'); 
    ?>
</body>
</html>