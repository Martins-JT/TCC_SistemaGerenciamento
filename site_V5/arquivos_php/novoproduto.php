...
$sql = "INSERT INTO produtos(id_fornecedor, produto, caracteristica, peso_unidade, estoque, descricao, categoria, valor) 
values(?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $conexao->prepare($sql);
$stmt->bind_param("issssssd", $fornecedor, $produto, $caracteristica, $peso, $unidade, $descricao, $categoria, $valor);
